<template>
  <Layout>
    <div class="container">
      <div class="hero">
        <h1 class="hero-title">{{ $page.posts2.title }}</h1>
      ...
      <div class="latest-journals">
        <div class="container">
          <a
            href=""
            class="journal"
            v-for="edge in $page.posts1.edges"
            :key="edge.node.id"
          >
            <h3 class="journal-title">{{ edge.node.name }}</h3>
          </a>
        </div>
      </div>
    </div>
